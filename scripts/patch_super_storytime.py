...
This raises bankruptcy / refinancing risk.
...
# Insert block after Red Flags header
txt = re.sub(
    r"(## 7\) Red flags[^\n]*\n)",
    r"\1" + RED_FLAG_BLOCK + "\n",
    txt,
...
print("✅ SUPER memo patched: storytime + de-jargon + red flags")
